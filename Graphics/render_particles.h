...
public:
	...
	GLint m_uLocPRadius[NumProg],m_uLocPScale[NumProg], m_uLocDiffuse,m_uLocAmbient,m_uLocPower, m_uLocSteps,m_uLocStepsS, m_uLocHueDiff,gPscale,gPradius, isG;
	unsigned int gBuffer,depth, gPosition, gNormal, gAlbedoSpec;;
	unsigned int attachments[4] = { GL_DEPTH_ATTACHMENT,GL_COLOR_ATTACHMENT0, GL_COLOR_ATTACHMENT1, GL_COLOR_ATTACHMENT2 };
