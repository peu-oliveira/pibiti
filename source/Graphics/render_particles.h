...
public:
	...
	GLint SigmaDomain, KernelCenter,KernelUni[15],camerax,cameray,cameraz, SPcamerax, SPcameray, SPcameraz,SPHEIGHT,SPWIDTH,Projection,ModelView;

	unsigned int gBuffer, depth, gPosition, gNormal, particleThickness, depthFB, Zvalue, ColorMap, depth2;
