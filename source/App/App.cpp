...
float3 App::camPosLag, App::camRotLag, App::dyePos;
float4 App::colliderPos;
int App::emitId = 0, App::cntRain = 0;
float App::modelView[16], App::fAspect, App::inertia = 0.06;

App::Modes App::mode = M_VIEW;
bool App::bWindowed = 0, App::bVsyncOff = 1, App::bShowInfo = 1;
int App::iTimes = 0, App::WSizeX = 1600, App::WSizeY = 1170;
...
char App::s[256];
uint App::timer[NumTim] = {
	0,
};
float App::tm[NumTim] = {
	0.f,
},
	  App::tdt = 0.f, App::tdts = 0.f, App::tm_si = 0.f;
float App::aq = PI2 / 40.f, App::barsScale = 30.f, App::fSimTime = 0.f;
int App::timAvgCnt = 2, App::timCnt = 0;

cSPH *App::psys = NULL;
ParticleRenderer *App::pParRend = NULL;

ParamListGL *App::curParList = NULL, *App::parLists[NumTabs] = {
										 NULL,
},
			*App::parLisE[NumEmit] = {
				NULL,
...
int App::tabWidths[NumTabs], App::tabPosX[NumTabs], App::tabHidden[NumTabs] = {
														0,
},
...
float3 App::tabClrs[NumTabs] = {
	{0.1, 0.4, 1.0}, {0.2, 0.5, 0.9}, {0.6, 0.6, 0.1}, {0.9, 0.2, 0.3}, {0.5, 0.5, 0.5}, {0.4, 0.5, 1.1}, {0.5, 0.4, 1.1}, {0.8, 0.4, 0.1}, {0.1, 0.7, 0.8}, {0.3, 0.6, 0.1}, {0.1, 0.6, 0.3}, {0.7, 0.2, 0.45}}; // {0.4,0.5,0.2}
// vis
...
int main(int argc, char **argv)
{
	...
	App::init();
	{
		...
		glutSpecialFunc(&App::KeySpecial);
		glutIdleFunc(idle);
